...
public:\
    virtual const tools::type* get_type() const { return tools::type::get<decltype(*this)>(); }\
private:
...
public:\
    virtual const tools::type* get_type() const override { return tools::type::get<decltype(*this)>(); }\
private:
