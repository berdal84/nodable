...
namespace ndbl {
    ...
    public:
        ...
        static void      start_drag(T* connector) { T::s_dragged = connector; }
        static const T*  get_hovered() { return T::s_hovered; }
        static const T*  get_dragged() { return T::s_dragged; }
        static const T*  get_focused() { return T::s_dragged; }
        static bool      is_dragging() { return T::s_dragged != nullptr; }
