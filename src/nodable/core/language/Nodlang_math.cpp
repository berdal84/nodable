...
REGISTER
{
    fw::registration::push_class<Nodlang_math>("Nodlang_math")
        ...
        .add_method<i16_t(i16_t)>(&_minus, "-")
        .add_method<double(double, double)>(&_minus, "-")
        .add_method<double(double, i16_t)>(&_minus, "-")
        .add_method<i16_t(i16_t, i16_t)>(&_minus, "-")
        .add_method<i16_t(i16_t, double)>(&_minus, "-")
        .add_method<double(double, double)>(&_divide, "/")
        .add_method<double(double, i16_t)>(&_divide, "/")
        .add_method<i16_t(i16_t, i16_t)>(&_divide, "/")
        .add_method<i16_t(i16_t, double)>(&_divide, "/")
        .add_method<double(double, double)>(&_multiply, "*")
        .add_method<double(double, i16_t)>(&_multiply, "*")
        .add_method<i16_t(i16_t, i16_t)>(&_multiply, "*")
        .add_method<i16_t(i16_t, double)>(&_multiply, "*")
        .add_method<double(double, double)>(&_minus, "-")
        .add_method<double(double, i16_t)>(&_minus, "-")
        .add_method<i16_t(i16_t, i16_t)>(&_minus, "-")
        .add_method<i16_t(i16_t, double)>(&_minus, "-")
        .add_method<bool(double, double)>(&_greater_or_eq, ">=")
        .add_method<bool(double, i16_t)>(&_greater_or_eq, ">=")
        .add_method<bool(i16_t, double)>(&_greater_or_eq, ">=")
        .add_method<bool(i16_t, i16_t)>(&_greater_or_eq, ">=")
        .add_method<bool(double, i16_t)>(&_lower_or_eq, "<=")
        ...
        .add_method<i16_t(i16_t & , i16_t)>(&_assign, "=")
        ...
        .add_method<bool(i16_t, i16_t)>(&_lower, "<")
        ...
        .add_method<i16_t(i16_t)>(&_sqrt, "sqrt")
        ...
        .add_method<std::string(i16_t)>(&_to_string, "to_string")
