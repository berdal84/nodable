...
namespace ndbl
{
    ...
    {
    public:
        using VariableNodeVec = std::vector<ID<VariableNode>>;
        ...
        virtual void                 add_variable(ID<VariableNode>) = 0;                              // Add a variable to this scope.
        ...
        virtual ID<VariableNode> find_variable(const std::string &_name) = 0;                         // Find a variable by name (identifier).
