...
namespace ndbl {
    ...
    public:
        ...
        inline std::unordered_map<tools::type::id_t , PoolID<Component>>::const_iterator
    ...
    private:
        ...
        std::unordered_map<tools::type::id_t, PoolID<Component>> m_components_by_type;
    };
    ...
    {
        static_assert( tools::is_base_of<Component, T>::value, "ComponentT must inherit from Component");
