...
namespace ndbl
{
    ...
    public:  tools::ComponentCollection<ASTNode>*       components()       { return &m_component_collection; }
    public:  const tools::ComponentCollection<ASTNode>* components() const { return &m_component_collection; }
    private: tools::ComponentCollection<ASTNode>        m_component_collection;
    protected:
