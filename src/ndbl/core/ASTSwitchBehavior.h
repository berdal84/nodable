...
namespace ndbl
{
    ...
    public:
        ...
        ASTNodeSlot*         branch_out(Branch branch)                       { ASSERT(branch < m_branch_count); return m_flow_out[branch]; }
        const ASTNodeSlot*   branch_out(Branch branch) const                 { ASSERT(branch < m_branch_count); return m_flow_out[branch]; }
    ...
    private:
        ...
        std::array<ASTNodeSlot*, BRANCH_MAX>    m_flow_out;
