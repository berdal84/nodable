...
Variant::Type Variant::type_to_enum(const Type_Descriptor* _type)
{
...
const Type_Descriptor* Variant::enum_to_type(Type _type)
{
    switch ( _type )
    {
...
bool Variant::is_type(const Type_Descriptor* _type) const
{
