...
typedef ::testing::Basic_Test _Type_Descriptor;

TEST_F(_Type_Descriptor, no_arg_fct)
{
    Type_Descriptor f;
    f.init<bool()>("fct");
...
TEST_F(_Type_Descriptor, push_single_arg)
{
    Type_Descriptor f;
...
TEST_F(_Type_Descriptor, push_two_args)
{
    Type_Descriptor f;
    f.init<bool(double)>("fct");
...
TEST_F(_Type_Descriptor, match_check_for_arg_count)
{
    Type_Descriptor f, g;
...
TEST_F(_Type_Descriptor, push_args_template_0)
{
    Type_Descriptor f, g;
    f.init<bool()>("fct");
    g.init<bool()>("fct");
...
TEST_F(_Type_Descriptor, push_args_template_1)
{
    Type_Descriptor f, g;
...
TEST_F(_Type_Descriptor, push_args_template_4)
{
    Type_Descriptor f, g;
