...
namespace ndbl
{
    ...
    */
    ...
    public:
        ...
        inline Node*          get_next_node() const {return m_next_node; }
        ...
        tools::qword          read_cpu_register(Register _register) const;
        // Get current program ptr*/
        const Code *          get_program_asm_code();
        // Check if a given Node is the next to be executed
        bool                  is_next_node(const Node* _node)const { return m_next_node == _node; }
    private:
