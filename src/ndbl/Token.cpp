...
{
    VERIFY(false, "This was previously returning the position of the token word on the global"
                  "parsed string, now it does not. We should change that.");
    return suffix_size;
}
