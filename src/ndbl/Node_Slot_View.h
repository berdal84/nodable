...
#include "Node_Slot.h"
#include "reflection/GETTERS_SETTERS.h"
...
namespace ndbl
{
    ...
    {   
        ...
        inline const Type_Descriptor* property_type()const                { return property() ? property()->type : nullptr; }
    };

    void        nodeslotview_init(Node_Slot_View*, Node_Slot*, const Vec2& /* alignment */,
                                  Shape_Type, u32_t /* index */, const Box_2D* /* alignment_ref */);
