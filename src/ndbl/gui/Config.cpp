...
void config_reset()
{
    ...
    g_config->actions = {
        ...
        {{ Event_Type_RESET_LAYOUT              }, "Arrange Selection"  , {SDLK_a, KMOD_NONE }, Condition_Flags_ENABLE_IF_HAS_SELECTION | Condition_Flags_HIGHLIGHTED_IN_GRAPH_EDITOR},
        {{ Event_Type_TOGGLE_FOLDING            }, "Fold Selection"     , {SDLK_x, KMOD_NONE }, Condition_Flags_ENABLE_IF_HAS_SELECTION | Condition_Flags_HIGHLIGHTED_IN_GRAPH_EDITOR},
        {{ Event_Type_SELECT_NEXT               }, "Next"               , {SDLK_n, KMOD_NONE }},
        {{ Event_Type_TOGGLE_ISOLATION_FLAGS    }, "Isolation"          , {SDLK_i, KMOD_CTRL }, Condition_Flags_ENABLE | Condition_Flags_HIGHLIGHTED_IN_TEXT_EDITOR},
        {{ Event_Type_MOVE                      }, "Drag whole "        , {SDLK_SPACE, KMOD_NONE, "Space + Drag" }, Condition_Flags_ENABLE | Condition_Flags_HIGHLIGHTED_IN_GRAPH_EDITOR},
        {{ Event_Type_FRAME_SELECTION           }, "Frame Selection"    , {SDLK_f, KMOD_NONE }, Condition_Flags_ENABLE_IF_HAS_SELECTION | Condition_Flags_HIGHLIGHTED_IN_GRAPH_EDITOR},
