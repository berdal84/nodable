...
namespace ndbl
{
    class Node_View_Contextual_Menu
    {
    public:
        Action_CreateNode*       draw_search_input(Node_Slot_View* _dragged_slot, size_t _result_max_count ); // Return the triggered action, user has to deal with the Action.
    ...
    private:
        ...
        void                     update_cache_based_on_signature(Node_Slot_View* _dragged_slot);
        void                     update_cache_based_on_user_input(Node_Slot_View* _dragged_slot, size_t _limit );
    };
}