...
#include "ndbl/gui/geometry/Rect.h"
    ...
    inline void layout_compute_sizes_and_positions()
    {
        ...
        for(auto it = layout()->elements.rbegin(); it != layout()->elements.rend(); ++it)
        {
            ...
            switch ( parent.container.main_axis)
            {
                ...
                default:
                {
                    UNREACHABLE("Unexpected Axis: %i", parent.container.main_axis );
                }
            }
        }
        ...
        for(auto it = layout()->elements.begin(); it != layout()->elements.end(); ++it)
        {
            ...
            switch ( element.container.main_axis)
            {
                ...
                default:
                {
                    UNREACHABLE("Unexpected Axis: %i", element.container.main_axis );
                }
            }
            ...
            {  
                ...
                {                
                    ...
                    default:
                    {
                        UNREACHABLE("Unexpected Container_Config: %i", element.container.main_axis );
                    }
                }
