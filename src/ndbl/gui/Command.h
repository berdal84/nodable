...
void command_##command_name##_do(ndbl::Command* command, ndbl::Context* context)

#define COMMAND_UNDO( command_name ) \
void command_##command_name##_undo(ndbl::Command* command, ndbl::Context* context)

#define COMMAND_REDO( command_name ) \
void command_##command_name##_redo(ndbl::Command* command, ndbl::Context* context)
...
namespace ndbl
{
    ...
    struct Command
    {
        typedef void(Contextual_Procedure_Type)(Command*, Context*);
    ...
    void    command_release(Command* command);
    void    command_do(Command*, Context*);
    void    command_redo(Command*, Context*);
    void    command_undo(Command*, Context*);
    

    COMMAND_DECLARE_WITH_ARGS(group, const char* /* name */)
