...
namespace Nodable
{
	...
	public:
        ...
        bool is_type(const R::Type* _type)const { return get_variant().is(_type); }
		...
		void set_type(const R::Type* _type) { get_variant().set_type(_type); }
		...
		const R::Type*        get_type()const { return get_variant().get_type(); }
