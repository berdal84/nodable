...
namespace Nodable
{
	...
	public:
        ...
        bool is_type(R::Type _type)const { return get_variant().is(_type); }
		...
		void set_type(R::Type _type) { get_variant().set_type(_type); }
		...
		R::Type               get_type()const { return get_variant().get_type(); }
