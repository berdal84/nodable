...
namespace Nodable {
	...
	*/
	...
	public:
        ...
        template<class T> inline T*       as() { return R::Type::cast_pointer<T>(this); }
        template<class T> inline const T* as()const { return R::Type::cast_pointer<const T>(this); }
        template<class T> inline bool     is()const { return R::Type::cast_pointer<const T>(this) != nullptr; }
