        ...
        , m_nodeView(_nodeView)
{
    ...
    if (m_member->allows_connection(Way_In) ) m_in  = new MemberConnector(this, Way_In, Side::Top);
    if (m_member->allows_connection(Way_Out) ) m_out = new MemberConnector(this, Way_Out, Side::Bottom);
}
