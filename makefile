...
$(EXECUTABLE): $(OBJ)main.o $(OBJ)Node.o $(OBJ)Node_Context.o $(OBJ)Log.o $(OBJ)Node_Value.o $(OBJ)Node_Number.o $(OBJ)Node_String.o $(OBJ)Node_Lexer.o
	$(CC) -o $(BIN)$(EXECUTABLE) $(OBJ)main.o $(OBJ)Node_Context.o $(OBJ)Node.o $(OBJ)Log.o  $(OBJ)Node_Value.o $(OBJ)Node_Number.o $(OBJ)Node_String.o $(OBJ)Node_Lexer.o $(CPPFLAGS)
...
$(OBJ)Node_Context.o: $(SRC)Node_Context.cpp
	$(CC) -o $(OBJ)Node_Context.o -c $(SRC)Node_Context.cpp $(CPPFLAGS)
$(SRC)Node_Context.cpp: $(SRC)Log.h $(SRC)Node_Number.h $(SRC)Node_String.h

$(OBJ)Node_Lexer.o: $(SRC)Node_Lexer.cpp
	$(CC) -o $(OBJ)Node_Lexer.o -c $(SRC)Node_Lexer.cpp $(CPPFLAGS)
$(SRC)Node_Lexer.cpp: $(SRC)Log.h $(SRC)Node_Context.h $(SRC)Node.h $(SRC)Nodable.h $(SRC)Node_Value.h  $(SRC)Node_Number.h  $(SRC)Node_String.h
